...
export interface GreeKTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_balances"
      | "_name"
  ...
  encodeFunctionData(
    functionFragment: "_tokenApprovals",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "hasURI", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "isApprovedForAll",
    data: BytesLike
  ): Result;
...
export interface GreeKToken extends BaseContract {
  connect(runner?: ContractRunner | null): GreeKToken;
  waitForDeployment(): Promise<this>;

  interface: GreeKTokenInterface;
  ...
  _tokenApprovals: TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  ...
  hasURI: TypedContractMethod<[tokenId: BigNumberish], [boolean], "view">;
  ...
  getFunction(
    nameOrSignature: "_tokenApprovals"
  ): TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  getFunction(
