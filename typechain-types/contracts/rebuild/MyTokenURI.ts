...
export interface MyTokenURIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_balances"
      | "_name"
...
export interface MyTokenURI extends BaseContract {
  connect(runner?: ContractRunner | null): MyTokenURI;
  waitForDeployment(): Promise<this>;

  interface: MyTokenURIInterface;
