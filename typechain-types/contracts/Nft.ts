...
export interface NftInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "NFT_URI", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "NFT_URI", data: BytesLike): Result;
...
export interface Nft extends BaseContract {
  ...
  NFT_URI: TypedContractMethod<[], [string], "view">;
